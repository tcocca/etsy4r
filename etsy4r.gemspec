...
Gem::Specification.new do |s|
  ...
  s.files = ["README", "LICENSE", "Rakefile", "VERSION.yml", "lib/etsy4r.rb", "lib/etsy4r/client.rb", "lib/etsy4r/commands.rb", "lib/etsy4r/favorite_commands.rb", "lib/etsy4r/gift_guide_commands.rb", "lib/etsy4r/image_parser.rb", "lib/etsy4r/response.rb", "lib/etsy4r/server_commands.rb", "lib/etsy4r/tag_commands.rb", "lib/etsy4r/user_commands.rb", "spec/rcov.opts", "spec/spec.opts", "spec/spec_helper.rb", "spec/fixtures/images.html", "spec/etsy4r/client_spec.rb", "spec/etsy4r/commands_spec.rb", "spec/etsy4r/favorite_commands_spec.rb", "spec/etsy4r/gift_guide_commands_spec.rb", "spec/etsy4r/image_parser_spec.rb", "spec/etsy4r/server_commands_spec.rb", "spec/etsy4r/tag_commands_spec.rb", "spec/etsy4r/user_commands_spec.rb", "tasks/rspec.rake", "examples/etsy.rb"]
  s.has_rdoc = true
